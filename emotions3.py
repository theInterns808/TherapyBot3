...
from emotion_recognition_using_speech.utils import extract_feature, AVAILABLE_EMOTIONS, get_best_estimators, get_audio_config
...
#        from emotion_recognition import EmotionRecognizer
        ...
        rec = EmotionRecognizer(model=my_model, emotions=['sad', 'sad', 'happy'], balance=True, verbose=0)
        ...
        loaded_model = pickle.load(open("/home/anrric/Desktop/TherapyMultiModalModel/speech_model.pkl"), "wb")
        
        # Save as WAV file
        with wave.open("/tmp/test_recording1.wav", 'wb') as wf:
            wf.setnchannels(1)
            wf.setsampwidth(2)  # 2 bytes for 'int16' dtype
            wf.setframerate(44100)
            wf.writeframes(record_audio()) 
        
        emotion = loaded_model.predict("/tmp/test_recording1.wav")
